...
utility(goal, 1).
utility(hole, -1).
utility(step, -0.04). % Costo de vida (R&N)
...
goal :- not(coor(3,4, 0)), coor(3,4, 1).
...
0.80::coor(1,1, 1); 0.10::coor(1,1, 1); 0.10::coor(2,1, 1) :- coor(1,1, 0), left.
0.80::coor(2,1, 1); 0.10::coor(1,1, 1); 0.10::coor(1,2, 1) :- coor(1,1, 0), up.
0.80::coor(1,1, 1); 0.10::coor(1,2, 1); 0.10::coor(1,1, 1) :- coor(1,1, 0), down.
...
% Meta, Trampa y Obstáculo absorben toda la masa y bloquean el movimiento.

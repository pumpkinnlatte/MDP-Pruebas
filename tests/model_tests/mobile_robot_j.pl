% Sí funciona, sólo hay que ver por qué es necesario comentar algunas transiciones, entender bien si blocked es necesario (siguiente iteración).
% Se corrigieron errores con respecto a la versión f
...
cost :- c1(0), not(c2(0)), not(c3(0)), c4(0), right. % from g to h
cost :- not(c1(0)), c2(0), not(c3(0)), not(c4(0)), up. % from l to h
cost :- c1(0), c2(0), not(c3(0)), not(c4(0)), down. % from d to h 
...
0.99::c1(1) :- c1(0), c2(0), not(c3(0)), not(c4(0)), left, not(blocked). %d
0.99::c2(1) :- c1(0), c2(0), not(c3(0)), not(c4(0)), left, not(blocked). %d
0.01::c3(1) :- c1(0), c2(0), not(c3(0)), not(c4(0)), left, not(blocked). %d
0.99::c4(1) :- c1(0), c2(0), not(c3(0)), not(c4(0)), left, not(blocked). %d
...
0.99::c2(1) :- c1(0), not(c2(0)), c3(0), not(c4(0)), down, not(blocked). %f

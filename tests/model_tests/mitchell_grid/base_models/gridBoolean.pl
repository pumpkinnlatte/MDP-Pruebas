...
%P(X | coor(1,2), a).
1.0::b1(1) :- not(b1(0)), b2(0), not(b3(0)), left.       %coor(1,2) to coor(1,1)

1.0::b1(1) :- not(b1(0)), b2(0), not(b3(0)), right.
1.0::b2(1) :- not(b1(0)), b2(0), not(b3(0)), right.        %coor(1,2) to coor(1,3)

1.0::b1(1) :- not(b1(0)), b2(0), not(b3(0)), down.
1.0::b3(1) :- not(b1(0)), b2(0), not(b3(0)), down.         %coor(1,2) to coor(2,2)

%P(X | coor(1,3), a).
1.0::b1(1) :- b1(0), b2(0), not(b3(0)), stay.              %ESTADO FINAL/META
1.0::b2(1) :- b1(0), b2(0), not(b3(0)), stay.              %ESTADO FINAL/META

%P(X | coor(2,1), a).
1.0::b1(1) :- not(b1(0)), not(b2(0)), b3(0), right.         
1.0::b3(1) :- not(b1(0)), not(b2(0)), b3(0), right.       %coor(2,1) to coor(2,2) 
 
1.0::b1(1) :- not(b1(0)), not(b2(0)), b3(0), up.          %coor(2,1) to coor(1,1) 

%P(X | coor(2,2), a).
1.0::b2(1) :- b1(0), not(b2(0)), b3(0), up.               %coor(2,2) to coor(1,2)

1.0::b3(1) :- b1(0), not(b2(0)), b3(0), left.             %coor(2,2) to coor(2,1)

1.0::b2(1) :- b1(0), not(b2(0)), b3(0), right.
1.0::b3(1) :- b1(0), not(b2(0)), b3(0), right.            %coor(2,2) to coor(2,3)
